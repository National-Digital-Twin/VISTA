...
- [Smart cache paralog API](https://github.com/Telicent-io/smart-cache-paralog-api)
- [Smart cache graph API](https://github.com/Telicent-io/smart-cache-graph-api)
- [JS Ontology Library](https://github.com/Telicent-io/js-ontology-lib) ?
