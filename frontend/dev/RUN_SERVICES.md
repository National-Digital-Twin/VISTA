...
The Transparent proxy is an nginx reverse proxy contained in the transparent-proxy folder of this repository. This needs to be built using the tag `paralog-transparent-proxy`, you must first update the proxy.conf.template to change
the resolver.
