...
export class OsNamesDataSourceHandler extends DataSourceHandler {
    ...
    private mapResponseToFeatures(response): Feature[] {
        return response.results.map((r) => {
            ...
            return {
                ...
                geometry: {
                    type: 'Point',
                    coordinates: this.mapBngCoordinatesToLatitudeLongitude(data.GEOMETRY_X, data.GEOMETRY_Y),
                },
                properties: {
    ...
    private mapBngCoordinatesToLatitudeLongitude(easting: any, northing: any): number[] {
