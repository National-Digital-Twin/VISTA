...
export default function SideBar() {
    const { isLoading: isLoadingAssessments, isError: isErrorAssessments } = useQuery({
    ...
    return (
        ...
        >
            ...
            >
                <FontAwesomeIcon icon={sidebarIsVisible ? faAngleLeft : faAngleRight} className="h-6 w-6" aria-hidden="true" />
            </Button>
