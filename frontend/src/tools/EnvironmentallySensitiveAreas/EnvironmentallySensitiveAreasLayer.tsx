...
export function EnvironmentallySensitiveAreasLayer({ layerId }: EnvironmentallySensitiveAreasLayerProps) {
    const { data } = useQuery({
    ...
    return (
        <Source key={layerId} id={layerId} type="geojson" data={data.default} generateId>
