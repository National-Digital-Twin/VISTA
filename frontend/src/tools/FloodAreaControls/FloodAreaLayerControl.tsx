...
export default function FloodAreaLayerControl({ searchQuery }: Readonly<LayerControlProps>) {
    const parentCategoryTerms = ['Flood Polygons', 'Flood', 'Floods', 'Flooding', 'Polygons'];
