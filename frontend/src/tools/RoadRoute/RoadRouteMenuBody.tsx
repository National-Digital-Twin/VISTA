...
export function RoadRouteMenuBody({ searchQuery, updateSelectedCount }: RoadRouteMenuBodyProps) {
    const { enabled, toggle } = useLayer('road-route');

    const { startPosition, endPosition, setStartPosition, setEndPosition, vehicleType, setVehicleType } = useRoadRouteSharedStore();
    ...
    const {
        ...
        onSelectMarkerPosition: useCallback((pos) => handleSelectPosition(pos, setStartPosition), [handleSelectPosition, setStartPosition]),
    });
    ...
    const {
        ...
        onSelectMarkerPosition: useCallback((pos) => handleSelectPosition(pos, setEndPosition), [handleSelectPosition, setEndPosition]),
    });
    ...
    return (
        <SearchConditional searchQuery={searchQuery} terms={['road', 'route', 'vehicle']}>
            <MenuItemRow
            ...
            {enabled && (
                <>
                    <div className="menu-info">
                        ...
                        <select name={kindDropdownID} id={kindDropdownID} value={vehicleType} onChange={handleSelectVehicleType}>
