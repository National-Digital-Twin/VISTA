    ...
    return (
        <li className={styles.connectedAssetDetails}>
            <Box className={styles.connectedAssetHeader}>
                <Box>
                    <Typography variant="h3" fontWeight="fontWeightBold" sx={{ fontSize: '14pt' }}>
                        {name || uri}
                    </Typography>
                    <Typography className={styles.connectedAssetUri} fontWeight="fontWeightRegular" sx={{ fontSize: '12pt' }}>
                        {uri.split('#')[1]}
                    </Typography>
                </Box>
            </Box>
            ...
            <Box>
                <Box sx={{ display: 'flex' }}>
                    <Typography variant="body1" fontWeight="fontWeightLight" sx={{ width: '40%', fontSize: '12pt', color: '#727781' }}>
                        Type:
                    </Typography>
                    <Typography variant="body1" fontWeight="fontWeightRegular" sx={{ width: '60%', fontSize: '12pt' }}>
