...
export default function SelectedElements({ selectedElements, showConnectedAssets, setConnectedAssetData }: SelectedElementsProps) {
...
function ElementsList({ selectedElements, showConnectedAssets, setConnectedAssetData }: ElementsListProps) {
    return (
