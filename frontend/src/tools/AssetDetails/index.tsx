...
export function AssetDetailControlPanel({ showConnectedAssets, setConnectedAssetData }: AssetDetailControlPanelContentProps) {
    return <InfoPanel showConnectedAssets={showConnectedAssets} setConnectedAssetData={setConnectedAssetData} />;
}
