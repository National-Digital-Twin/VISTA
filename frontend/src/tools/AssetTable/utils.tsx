...
export function download(assets: Asset[], dependencies: Dependency[], format: 'csv' | 'xlsx') {
    ...
    if (format === 'csv') {
        ...
        utils.book_append_sheet(wb, utils.aoa_to_sheet(dependenciesTable), 'Dependencies');
