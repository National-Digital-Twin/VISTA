                                ...
                                <Box sx={{ display: 'flex' }}>
                                    ...
                                    >
                                        <Box display="flex" alignItems="center" sx={{ marginLeft: '10px' }}>
                                            ...
                                            <MaterialUISwitch checked={showPrimary} onChange={toggleShowPrimary} />
                                        </Box>
                                    </Box>
                                    <Box sx={{ display: 'flex' }}>
                                        <Box display="flex" alignItems="center" sx={{ marginLeft: '10px' }}>
                                            <Typography>Dependent Assets</Typography>
                                            <MaterialUISwitch checked={showSecondary} onChange={toggleShowSecondary} />
                                        </Box>
                                    </Box>
                                </Box>
                            </CardContent>
...
function CriticalitySlider() {
    ...
    useEffect(() => {
        const currentValue = Math.max(0, assetCriticalities.indexOf(minCriticality));
