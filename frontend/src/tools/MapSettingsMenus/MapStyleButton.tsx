...
import { Box, Radio, FormControlLabel, FormControl, FormLabel, RadioGroup } from '@mui/material';
...
export default function MapStyleButton() {
    ...
    const { value: showMapStyles, toggle: toggleMapStyleMenu, setFalse: hideMapStyleMenu } = useBoolean(false);
    ...
    return (
        <Box sx={{ display: 'flex', justifyContent: 'end', pointerEvents: 'auto' }} ref={ref}>
            {showMapStyles && (
                <Box
            ...
            <ToolbarButton title="Map style menu" onClick={toggleMapStyleMenu} svgSrc="/icons/Stacks.svg" />
        </Box>
    );
}
