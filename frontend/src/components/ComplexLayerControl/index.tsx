...
export interface ComplexLayerControlProps {
    ...
    /** Children */
    readonly children: ReactNode | ((updateSelectedCount: (isSelected: boolean) => void) => ReactNode);
...
export default function ComplexLayerControl({ icon, title, children, autoShowHide = false, hideCount }: ComplexLayerControlProps) {
    ...
    return (
        ...
        >
            ...
            >
                ...
                >
                    {typeof children === 'function' ? children(updateSelectedCount) : children}
                </Box>
            </Box>
        </Box>
    );
