...
export default function SimpleLayerControl({ layerName, title, searchQuery, terms, updateSelectedCount }: SimpleLayerControlProps) {
    ...
    return <MenuItemRow checked={enabled} onChange={handleToggle} primaryText={title} terms={fullTerms} searchQuery={searchQuery} />;
}
