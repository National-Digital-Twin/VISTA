...
import { ListItem, ListItemText, Box, IconButton, SvgIcon } from '@mui/material';
...
const MenuItemRow = ({ terms, primaryText, checked, onChange, searchQuery, children, buttons }: MenuItemRowProps) => {
    return (
        <SearchConditional searchQuery={searchQuery} terms={terms}>
            ...
            >
                ...
                {onChange && <MaterialUISwitch checked={checked} onChange={onChange} inputProps={{ 'aria-label': 'controlled' }} />}
            </ListItem>
        </SearchConditional>
    );
};
