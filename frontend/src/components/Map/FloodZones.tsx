...
function FloodAreaListItem({ selectedFloodZone, selectedTimeline, onTimelineClick }: FloodAreaListItemProps) {
    const onClick = useCallback(() => onTimelineClick(selectedFloodZone), [onTimelineClick, selectedFloodZone]);
