...
export default function ControlPanel({ connectedAssetsPanelOpen, hideConnectedAssets, showConnectedAssets }: ControlPanelProps) {
    ...
    const tabs = [
        ...
        },
        {
            ...
            content: <AssetDetailControlPanel showConnectedAssets={showConnectedAssets} setConnectedAssetData={setConnectedAssetData} />,
        },
    ];
                    ...
                    <Tabs
                        ...
                        slotProps={{
                            indicator: {
                                ...
                                children: <Typography component="span" className="MuiTabs-indicatorSpan"></Typography>,
                            },
                        }}
                        sx={{
                            'display': 'flex',
                        ...
                        {tabs.map((entry, index) => (
                            <Tab
                                ...
                                label={
                                    ...
                                    >
                                        <Typography sx={{ textTransform: 'none', fontWeight: 'bold' }}>{entry.name}</Typography>
                                    </Box>
                                }
                                {...a11yProps(index)}
                                sx={{ flexBasis: '50%' }}
