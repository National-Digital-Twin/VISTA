...
export default function ControlsOverlay() {
    const { value: controlPanelOpen, setTrue: showControlPanel, setFalse: hideControlPanel } = useBoolean(true);

    const { value: dependantPanelOpen, setTrue: showConnectedAssetsPanel, setFalse: hideConnectedAssetsPanel } = useBoolean(false);
    ...
    const shouldShowControlPanel = featureFlags.uiNext && (controlPanelOpen || showPolygonToolbar);
