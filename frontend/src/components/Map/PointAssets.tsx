...
function MarkerWithTooltip({ feature, isSelected, onAssetClick, assets, dependencies }: MarkerWithTooltipProps) {
    ...
    const onClick = useCallback(
        ...
        [onAssetClick, feature, featureType, latitude, longitude, selectTrainStation, deselectStation],
    );

    const fontAwesomeIconName = iconStyles.faIcon?.split(' ').pop()?.replace('fa-', '');
    ...
    return (
        <Marker key={featureURI} longitude={longitude} latitude={latitude} onClick={onClick} style={{ cursor: 'pointer' }}>
            <div className={styles.markerWithTooltipContent}>
                <div className={styles.tooltip}>
                    <InfoTooltip element={element} />
                </div>
                {showCpsIconsForAssetTypes ? (
                    <CpsAssetIcon className={styles.cpsAssetIcon}>{iconStyles.iconFallbackText}</CpsAssetIcon>
                ) : (
                    <div
...
function AssetIcons({ features, isSelected, onAssetClick, assets, dependencies }: AssetIconsProps) {
    return (
        <>
