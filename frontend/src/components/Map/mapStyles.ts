...
function getMapTilerStyles(darkMode: boolean): MapStyle[] {
    ...
    return [
        ...
        {
            id: createMapTilerStyle(`https://api.maptiler.com/maps/streets-v2${darkLight}/style.json`),
            name: 'Streets',
            key: 'streets',
        },
        {
        ...
        {
            id: createMapTilerStyle(`https://api.maptiler.com/maps/basic-v2${darkLight}/style.json`),
            name: 'Basic',
            key: 'basic',
        },
        {
            id: createMapTilerStyle(`https://api.maptiler.com/maps/bright-v2${darkLight}/style.json`),
            name: 'Bright',
            key: 'bright',
        },
    ].filter((x) => x);
