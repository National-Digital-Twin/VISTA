...
const ConnectedAssetsPanel: React.FC<ConnectAssetPanelProps> = ({ connectedAssetData, hideConnectedAssets }) => {
        ...
        >
            ...
            >
                <Box>
                    ...
                    >
                        <Tab label={`Dependant Assets (${totalDependents}) `} {...a11yProps(0)} sx={{ flexBasis: '53%' }} />
                        <Tab label={`Provider Assets (${totalProviders}) `} {...a11yProps(1)} sx={{ flexBasis: '47%' }} />
                    </Tabs>
