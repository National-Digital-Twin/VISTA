...
export interface State {
  ...
  dynamicProximityFeatures: Feature<
    Polygon,
    DynamicProximityFeatureProperties
  >[];
  addDynamicProximityFeatures: (
    features: Feature<Polygon, DynamicProximityFeatureProperties>[],
  ) => void;
  updateDynamicProximityFeatures: (
    features: Feature<Polygon, DynamicProximityFeatureProperties>[],
  ) => void;
  deleteDynamicProximityFeatures: (
...
export default createStore<State>("application-state-storage", (set) => ({
  ...
  deselectAssetType: (assetType) =>
    set((state) => {
      const { [assetType]: _assetType, ...selectedAssetTypes } =
  ...
  showPrimary: true,
  toggleShowPrimary: () =>
    set((state) => ({ showPrimary: !state.showPrimary })),
  showSecondary: false,
  toggleShowSecondary: () =>
    set((state) => ({ showSecondary: !state.showSecondary })),
  showLiveFloods: false,
  toggleShowLiveFloods: () =>
    set((state) => ({ showLiveFloods: !state.showLiveFloods })),
  minCriticality: 0,
  setMinCriticality: (criticality) =>
    set(() => ({ minCriticality: criticality })),
  selectedFloodAreas: [],
  ...
  setFloodAreaFeatures: (features) =>
    set(() => ({ floodAreaFeatures: features })),
  ...
  updateDynamicProximityFeatures: updateFeatures(
    "dynamicProximityFeatures",
    set,
  ),
