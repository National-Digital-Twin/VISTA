...
class TestAssetFilterBuilderSQL:
    ...
    def test_by_asset_type_mode_single_type_no_score_filter(self, scenario, asset_type_setup, mock_user_id):
    ...
    def test_by_asset_type_mode_multiple_types_mixed_filters(self, scenario, asset_type_setup, mock_user_id):
...
class TestAssetFilterBuilderExposureExecution:
    ...
    def exposure_test_setup(self, scenario, mock_user_id):
        ...
        sub_category = AssetSubCategory.objects.create(id=uuid.uuid4(), name="Test Sub", category=category)
        data_source = DataSource.objects.create(id=uuid.uuid4(), name="Test Source")
