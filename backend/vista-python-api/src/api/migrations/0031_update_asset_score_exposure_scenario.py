                    ...
                    FROM api_scenarioasset s_a
                        ...
                        LEFT JOIN ( SELECT a_d.provider_asset_id AS id,
                            ...
                            FROM api_dependency a_d
                                ...
                                ON dep_score.id::text = a.external_id::text
                        LEFT JOIN ( SELECT veas.asset_id,
                            ...
                            FROM visible_exposure_asset_scores veas) exposure
                                ON exposure.asset_id = a.id
                                AND exposure.scenario_id = s_a.scenario_id
                    GROUP BY a.id, s_a.scenario_id, exposure.user_id,
                        s_a.criticality_score, exposure.score;
            """,
            reverse_sql="""
