...
"""Generated by Django 5.2.9 on 2025-12-22 16:07."""
...
class Migration(migrations.Migration):
    """Add `impacts_exposure_score` bool to `exposurelayertype` model and filter out of views."""

    dependencies: ClassVar = [
        ("api", "0038_add_assettype_icon"),
    ]

    operations: ClassVar = [
        migrations.AddField(
            model_name="exposurelayertype",
            name="impacts_exposure_score",
            field=models.BooleanField(default=True),
        ),
        # Filter out any exposure layer which doesn't impact exposure score
        migrations.RunSQL(
            sql="""
                DROP MATERIALIZED VIEW public.assets_within_500m_exposure_layers CASCADE;
            ...
            """,
            reverse_sql="""
                DROP MATERIALIZED VIEW public.assets_within_500m_exposure_layers;
                CREATE MATERIALIZED VIEW public.assets_within_500m_exposure_layers AS
                SELECT a.id AS asset_id,
                    e.id AS exposure_layer_id,
                    st_intersects(a.geom::geography, e.geometry::geography) AS intersects
        ...
        # No changes to visible_exposure_asset_scores view, same as before.
        migrations.RunSQL(
            sql="""
