    ...
    FROM api_scenarioasset s_a
        ...
        LEFT JOIN ( SELECT a_d.provider_asset_id AS id,
            ...
            FROM api_dependency a_d
                LEFT JOIN api_asset a_1 ON a_d.dependent_asset_id::text = a_1.external_id::text
                LEFT JOIN api_scenarioasset s_a_1 ON s_a_1.asset_type_id = a_1.type_id) dep_score ON dep_score.id::text = a.external_id::text
